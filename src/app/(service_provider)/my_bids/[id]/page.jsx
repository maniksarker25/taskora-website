      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
          <div className="flex items-center gap-4">
            <Link
              href="/my_bids"
              className="inline-flex items-center gap-3 px-4 py-3 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-100 hover:border-[#115E59] group"
            >
          ...
          {currentStatus === "Progress" && (
            ...
            >
              <Handshake className="w-5 h-5 group-hover:scale-110 transition-transform text-center" />
